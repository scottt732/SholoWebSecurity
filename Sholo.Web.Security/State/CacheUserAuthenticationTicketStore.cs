...
namespace Sholo.Web.Security.State
{
    ...
    /// </summary>
    public sealed class CacheUserAuthenticationTicketStore : IUserAuthenticationTicketStore
    {
        /// <summary>
        /// This prefix is prepended to server ticket key as the key to the cache.
        /// </summary>
        ...
        /// </summary>
        internal CacheUserAuthenticationTicketStore() { }

        /// <summary>
        /// Initializes the CacheUserAuthenticationTicketStore module.
        /// </summary>
        ...
        public UserAuthenticationTicket GetTicket(string userAuthenticationTicketKey)
        {
            ...
            else if (string.IsNullOrEmpty(userAuthenticationTicketKey))
            {
        ...
        public void InsertTicket(UserAuthenticationTicket ticket, DateTime expiration)
        {
            if (ticket == null)
            {
        ...
        /// <exception cref="ArgumentNullException">UserAuthenticationTicket is null</exception>
        public void UpdateTicketExpiration(UserAuthenticationTicket ticket, DateTime newExpiration)
        {
            if (ticket == null)
            {
                throw new ArgumentNullException("ticket", "UserAuthenticationTicket parameter cannot be null.");
        ...
        /// <exception cref="ArgumentNullException">userAuthenticationTicketKey is null</exception>
        /// <exception cref="ArgumentException">userAuthenticationTicketKey is empty</exception>
        public void RevokeTicket(string userAuthenticationTicketKey)
        {
            if (userAuthenticationTicketKey == null)
            {
                throw new ArgumentNullException("userAuthenticationTicketKey", "userAuthenticationTicketKey parameter cannot be null or empty.");
        ...
        /// <exception cref="ArgumentNullException">userAuthenticationTicketKey is null</exception>
        /// <exception cref="ArgumentException">userAuthenticationTicketKey is empty</exception>
        public bool ContainsTicket(string userAuthenticationTicketKey)
        {
            if (userAuthenticationTicketKey == null)
            {
                throw new ArgumentNullException("userAuthenticationTicketKey", "userAuthenticationTicketKey parameter cannot be null or empty.");
        ...
        public void RevokeUserTickets(string username)
        {
            if (username == null)
            {
            ...
            {
                if (String.Compare(ticket.Username, username, true) == 0)
                {
                    RevokeTicket(ticket.Key);
                }
            }
        ...
        public IEnumerable<UserAuthenticationTicket> GetAllTickets()
        {
            IDictionaryEnumerator enumerator = HttpContext.Current.Cache.GetEnumerator();
            while (enumerator.MoveNext())
            {
        ...
        public IEnumerable<UserAuthenticationTicket> GetUserTickets(string username)
        {
            if (username == null)
            {
                throw new ArgumentNullException("username", "username parameter cannot be null or empty.");
            ...
            while (enumerator.MoveNext())
            {
                ...
                {
                    UserAuthenticationTicket currentTicket = enumerator.Entry.Value as UserAuthenticationTicket;
                    if (currentTicket != null && String.Compare(currentTicket.Username, username, true) == 0)
                    {
                        yield return currentTicket;
                    }
                }
        ...
        public IEnumerable<string> GetAllTicketKeys()
        {
            IDictionaryEnumerator enumerator = HttpContext.Current.Cache.GetEnumerator();
            while (enumerator.MoveNext())
            {
        ...
        /// <exception cref="ArgumentNullException">username is null</exception>
        /// <exception cref="ArgumentException">username is empty</exception>
        public IEnumerable<string> GetUserTicketKeys(string username)
        {
            if (username == null)
            {
                throw new ArgumentNullException("username", "username parameter cannot be null or empty.");
            ...
            while (enumerator.MoveNext())
            {
                ...
                {
                    UserAuthenticationTicket currentAuthTicket = enumerator.Entry.Value as UserAuthenticationTicket;
                    if (currentAuthTicket != null && String.Compare(currentAuthTicket.Username, username, true) == 0)
                    {
                        yield return currentAuthTicket.Key;
                    }
                }
        ...
        /// </returns>
        public bool VerifyTicket(UserAuthenticationTicket ticket)
        {
            if (ticket == null)
            {
                throw new ArgumentNullException("ticket", "UserAuthenticationTicket parameter cannot be null.");
            ...
            if (cacheAuthTicket != null)
            {
                ...
                {
                    if (String.Compare(cacheAuthTicket.Username, ticket.Username, true) != 0)
                    {
                        return false;
                    }
        ...
        /// <summary>
        /// Converts a UserAuthenticationTicket Key to a corresponding 
        /// key in the ticket manager store (cache provider). 
        /// </summary>
        /// <param name="ticketKey">
        /// The UserAuthenticationTicket Key to convert.
        /// </param>
        /// <returns>
        /// The cache key associated with the UserAuthenticationTicket Key
        /// </returns>
        /// <exception cref="ArgumentNullException">userAuthenticationTicketKey is null</exception>
        /// <exception cref="ArgumentException">userAuthenticationTicketKey is empty</exception>
        private static string GetCacheKey(string ticketKey)
        {
            if (ticketKey == null)
            {
                throw new ArgumentNullException("ticketKey", "userAuthenticationTicketKey parameter cannot be null or empty.");
            }
            if (string.IsNullOrEmpty(ticketKey))
            {
                throw new ArgumentException("userAuthenticationTicketKey parameter cannot be null or empty.", "ticketKey");
            }
